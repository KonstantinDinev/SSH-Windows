...
Now read careful! Go to Computer Configuration > Windows Settings > Security Policies > Local Policies > User Rights Assignment = __Deny log on locally__ > delete our ssh account here (cyg_server)
